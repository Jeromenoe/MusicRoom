...
/*
    L'objet qu'on va construire pour renvoyer au controller et afficher
    les infos sur cet ami
 */

/*
 L'objet est minimaliste au niveau des playlist, des amis et des events, il permet
 uniquement de renvoyer les noms des informations. On ne peut pas cliquer dessus.
 */
...
//        self.friendProfileObject.removeAll()
