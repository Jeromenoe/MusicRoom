...
//            if (barPos != -1 && barPos != barDuration.value) {
//                if (barDuration.value > 0.96) {
//                    self.nextTrack()
//                    barPos = Float(-1)
//                    checkNext = 1
//                } else {
//                    let newPosition = duration * barDuration.value
//                    playerView?.appRemote.playerAPI?.seek(toPosition: Int(newPosition), callback: controlDelegSendInfo)
//                }
//            } else {
//                let progress = Float(playerState.playbackPosition) / duration
//                barDuration.setValue(Float(progress), animated: false)
//            }
//            if (playerState.playbackPosition < 2000) {
//                updatePlayerDetails(playerState: playerState)
//                playerView?.updatePlayer(playerState: playerState)
//            }
//            lblProgress.text = Double(playerState.playbackPosition / 1000).durationText
//            intDuration = Int(playerState.playbackPosition / 1000)
